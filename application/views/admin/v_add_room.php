	...
	<div class="row" style="margin-top: 10px;">
		<div class="col-lg-2">
			<ul class="nav nav-pills nav-stacked">
				...
				<li role="presentation" class="active"><a href="<?php echo base_url();?>Admin/addRoom">Add Room</a></li>
							...
							<tr>
								...
								<!--<tr>
							  	...
							  	<tr>
							  		...
							  		<tr>
							  			<td></td>
							  			<td align="right"><input  class="btn btn-primary" type="submit" name="btnRoom" value="Save" /></td>
							  		</tr>
							  	</table>
