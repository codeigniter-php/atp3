...
--
-- Host: localhost
-- Generation Time: Mar 21, 2016 at 09:39 PM
...
INSERT INTO `booking` (`id`, `class_id`, `days_id`, `s_time`, `e_time`, `room_no`, `booking_status`, `date`) VALUES
(1, 5, 1, '09:30:00', '11:00:00', 404, 'Active(2016-03-27)', '2016-03-27'),
(2, 2, 1, '09:30:00', '10:30:00', 404, 'Active(2016-03-27)', '2016-03-27'),
(3, 2, 2, '03:30:00', '05:00:00', 401, 'Active(2016-03-28)', '2016-03-28'),
(4, 3, 2, '04:00:00', '06:00:00', 401, 'Active(2016-03-07)', '2016-03-07'),
(5, 5, 2, '08:00:00', '09:00:00', 401, 'Pending', '2016-03-14'),
(6, 5, 1, '13:00:00', '14:30:00', 403, 'Active(2016-03-20)', '2016-03-20'),
(7, 3, 1, '09:30:00', '11:00:00', 402, 'Active(2016-03-27)', '2016-03-27');
...
CREATE TABLE IF NOT EXISTS `class_schedule` (
  ...
  `t0` varchar(100) DEFAULT NULL,
  `t0.5` varchar(100) DEFAULT NULL,
  `t1` varchar(100) DEFAULT NULL,
  `t1.5` varchar(100) DEFAULT NULL,
  `t2` varchar(100) DEFAULT NULL,
  `t2.5` varchar(100) DEFAULT NULL,
  `t3` varchar(100) DEFAULT NULL,
  `t3.5` varchar(100) DEFAULT NULL,
  `t4` varchar(100) DEFAULT NULL,
  `t4.5` varchar(100) DEFAULT NULL,
  `t5` varchar(100) DEFAULT NULL,
  `t5.5` varchar(100) DEFAULT NULL,
  `t6` varchar(100) DEFAULT NULL,
  `t6.5` varchar(100) DEFAULT NULL,
  `t7` varchar(100) DEFAULT NULL,
  `t7.5` varchar(100) DEFAULT NULL,
  `t8` varchar(100) DEFAULT NULL,
  `t8.5` varchar(100) DEFAULT NULL,
  `t9` varchar(100) DEFAULT NULL,
  `t9.5` varchar(100) DEFAULT NULL,
  `t10` varchar(100) DEFAULT NULL,
  `t10.5` varchar(100) DEFAULT NULL,
  `t11` varchar(100) DEFAULT NULL,
  `t11.5` varchar(100) DEFAULT NULL,
...
(2, 1, '401', 'R', 'R', 'R', '', '', '', '', '', 'R', 'R', 'R', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(3, 2, '401', 'R', 'R', 'R', '', 'R', 'R', 'R', 'R', 'R', 'R', '', '', 'R', 'R', '', '', '', '', '', '', '', '', 'R', 'R', 'R'),
(4, 1, '404', 'R', 'R', 'R', 'M', 'M', 'M', 'M', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(5, 1, '402', 'R', 'R', 'R', 'M', 'M', 'M', 'M', '', '', 'R', 'R', 'R', 'R', '', '', '', '', '', '', '', '', '', '', '', ''),
(6, 1, '403', 'R', 'R', 'R', 'R', 'R', '', '', '', '', '', 'M', 'M', 'M', 'M', '', '', '', '', '', '', '', '', '', '', ''),
(7, 1, 'CL1', 'R', 'R', 'R', 'R', 'R', 'R', 'R', 'R', 'R', 'R', 'R', 'R', 'R', '', '', '', '', '', '', '', '', '', '', '', ''),
(8, 3, '401', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(9, 6, '401', 'R', 'R', 'R', 'R', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(5, 'ss@gmail.com', 'pworld7487', 'Ahmed Shabbir', 'teacher'),
(6, 'p@gmail.com', '415744', 'pius', 'teacher');
